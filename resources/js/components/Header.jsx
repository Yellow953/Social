...
export default function Header({ activeTab }) {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 bg-white/50 backdrop-blur-md shadow-lg border-b border-gray-100/50 overflow-visible" style={{ borderBottomLeftRadius: '3rem', borderBottomRightRadius: '3rem' }}>
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    ...
                    >
                        <div className="w-12 h-12 bg-gradient-to-br from-[#ec682a] to-[#d45a20] rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                            <i className="fas fa-book text-white text-lg"></i>
                        </div>
                        <span className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-[#1e3a8a] to-[#3b82f6] bg-clip-text text-transparent">ESIB SOCIAL</span>
                    </Link>
