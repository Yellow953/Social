...
<div class="min-vh-100 d-flex align-items-center position-relative" style="background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 50%, #1e3a8a 100%); overflow: hidden;">
    ...
    <div class="position-absolute top-0 start-0 w-100 h-100" style="opacity: 0.4;">
        ...
        <div class="position-absolute" style="bottom: 20%; left: 25%; width: 120px; height: 120px; background: #ec682a; border-radius: 50%; animation: float 7s ease-in-out infinite;"></div>
        <div class="position-absolute" style="top: 35%; right: 25%; width: 100px; height: 100px; background: #ec682a; border-radius: 50%; animation: float 9s ease-in-out infinite;"></div>
    </div>
