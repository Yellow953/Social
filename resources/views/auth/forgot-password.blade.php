...
<div class="min-vh-100 d-flex align-items-center position-relative" style="background: linear-gradient(135deg, #1a2744 0%, #243b5c 50%, #1e3a5f 100%); overflow: hidden;">
    ...
    <div class="position-absolute top-0 start-0 w-100 h-100" style="opacity: 0.5;">
        ...
        <div class="position-absolute" style="bottom: 20%; left: 25%; width: 120px; height: 120px; background: rgba(236,104,42,0.4); border-radius: 50%; animation: float 7s ease-in-out infinite;"></div>
        <div class="position-absolute" style="top: 35%; right: 25%; width: 100px; height: 100px; background: rgba(236,104,42,0.4); border-radius: 50%; animation: float 9s ease-in-out infinite;"></div>
    </div>
