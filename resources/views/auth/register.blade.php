...
@section('content')
<div class="min-vh-100 d-flex align-items-center py-5 position-relative" style="background: linear-gradient(135deg, #c2410c 0%, #ec682a 50%, #d45a20 100%); overflow: hidden;">
    <!-- White Bubbles -->
    <div class="position-absolute top-0 start-0 w-100 h-100" style="opacity: 0.5;">
        <div class="position-absolute" style="top: 5%; left: 5%; width: 250px; height: 250px; background: rgba(255,255,255,0.5); border-radius: 50%; animation: float 6s ease-in-out infinite;"></div>
        <div class="position-absolute" style="top: 50%; right: 10%; width: 180px; height: 180px; background: rgba(255,255,255,0.5); border-radius: 50%; animation: float 8s ease-in-out infinite;"></div>
        <div class="position-absolute" style="bottom: 15%; left: 15%; width: 120px; height: 120px; background: rgba(255,255,255,0.5); border-radius: 50%; animation: float 7s ease-in-out infinite;"></div>
        <div class="position-absolute" style="top: 30%; right: 30%; width: 140px; height: 140px; background: rgba(255,255,255,0.5); border-radius: 50%; animation: float 9s ease-in-out infinite;"></div>
        <div class="position-absolute" style="bottom: 40%; right: 5%; width: 90px; height: 90px; background: rgba(255,255,255,0.5); border-radius: 50%; animation: float 5s ease-in-out infinite;"></div>
        <div class="position-absolute" style="top: 70%; left: 30%; width: 110px; height: 110px; background: rgba(255,255,255,0.5); border-radius: 50%; animation: float 6.5s ease-in-out infinite;"></div>
    </div>
