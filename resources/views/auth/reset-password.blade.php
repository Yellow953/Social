...
<div class="min-vh-100 d-flex align-items-center position-relative" style="background: linear-gradient(135deg, #c2410c 0%, #ec682a 50%, #d45a20 100%); overflow: hidden;">
    ...
    <div class="position-absolute top-0 start-0 w-100 h-100" style="opacity: 0.5;">
        ...
        <div class="position-absolute" style="bottom: 25%; left: 20%; width: 130px; height: 130px; background: rgba(255,255,255,0.5); border-radius: 50%; animation: float 7s ease-in-out infinite;"></div>
        <div class="position-absolute" style="top: 40%; right: 30%; width: 110px; height: 110px; background: rgba(255,255,255,0.5); border-radius: 50%; animation: float 9s ease-in-out infinite;"></div>
    </div>
