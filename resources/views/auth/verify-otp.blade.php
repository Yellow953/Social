...
@section('title', 'Verify Email - Social Plus')
                ...
                <div class="card border-0 shadow-lg bg-white">
                    <div class="card-body p-5">
                        ...
                        <div class="text-center mb-4">
                            <i class="bi bi-envelope-check fs-1 mb-3" style="color: #ec682a;"></i>
                        ...
                        <form method="POST" action="{{ route('verify-otp') }}">
                            ...
                            <div class="text-center">
                                <a href="{{ route('register') }}" class="text-decoration-none fw-semibold small" style="color: #ec682a;">
