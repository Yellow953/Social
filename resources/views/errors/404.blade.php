...
@section('title', '404 Page Not Found | ESIB SOCIAL')
...
<div class="min-vh-100 d-flex align-items-center position-relative" style="background: linear-gradient(135deg, #c2410c 0%, #ec682a 50%, #d45a20 100%); overflow: hidden;">
    ...
    <div class="position-absolute top-0 start-0 w-100 h-100" style="opacity: 0.5;">
        ...
        <div class="position-absolute" style="bottom: 40%; right: 10%; width: 80px; height: 80px; background: rgba(255,255,255,0.5); border-radius: 50%; animation: float 5s ease-in-out infinite;"></div>
    </div>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card border-0 shadow-lg bg-white">
                    <div class="card-body p-5 text-center">
                        <!-- Icon -->
                        <div class="mb-4">
                            <i class="fas fa-exclamation-triangle" style="font-size: 5rem; color: #ec682a;"></i>
                        </div>
                        
                        <!-- Error Code -->
                        <h1 class="display-1 fw-bold mb-3" style="color: #ec682a;">404</h1>
                        
                        <!-- Title -->
                        <h2 class="fw-bold mb-3" style="color: #5c5c5c;">Page Not Found</h2>
                        
                        <!-- Message -->
                        <p class="text-muted mb-4 lead">Oops! The page you're looking for doesn't exist or has been moved.</p>
