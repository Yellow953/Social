...
@section('title', '500 Server Error | ESIB SOCIAL')
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card border-0 shadow-lg bg-white">
                    <div class="card-body p-5 text-center">
                        <!-- Icon -->
                        <div class="mb-4">
                            <i class="fas fa-server" style="font-size: 5rem; color: #ec682a;"></i>
                        </div>
                        
                        <!-- Error Code -->
                        <h1 class="display-1 fw-bold mb-3" style="color: #ec682a;">500</h1>
                        
                        <!-- Title -->
                        <h2 class="fw-bold mb-3" style="color: #5c5c5c;">Server Error</h2>
                        
                        <!-- Message -->
                        <p class="text-muted mb-4 lead">Something went wrong on our end. We're working to fix it. Please try again later.</p>
