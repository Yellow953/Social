...
@section('title', 'Privacy Policy | ESIB SOCIAL')
@section('meta_description', 'Read the ESIB SOCIAL Privacy Policy. Learn how we collect, use, and protect your personal information, cookies, and data.')
@section('og_title', 'Privacy Policy | ESIB SOCIAL')
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-lg overflow-hidden" style="border-left: 4px solid #ec682a !important;">
            <div class="card-body p-5">
                @include('partials.policy.header', ['title' => 'Privacy Policy'])
                ...
                <div class="content">
                    ...
                    <section class="mb-5">
                        ...
                        <p class="text-muted">
                            ...
                            For more details, see our <a href="{{ route('cookie-policy') }}" style="color: #ec682a;">Cookie Policy</a>.
                        </p>
                    </section>
